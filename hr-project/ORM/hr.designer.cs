...
namespace ORM
{
    ...
    partial void Onacc_changetimeChanged();
		...
		[Column(Storage="_acc_id", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		[DataMember(Order=1)]
		public int acc_id
		{
			get
		...
		[Column(Storage="_acc_deductionsway", DbType="NVarChar(1)")]
		[DataMember(Order=6)]
		...
		public EntitySet<cstructure> cstructure
		{
			...
			{
				if ((this.serializing 
							&& (this._cstructure.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
    ...
    partial void Oncou_percentChanged();
		...
		[Column(Storage="_cou_id", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		[DataMember(Order=1)]
		public int cou_id
		{
			get
    ...
    partial void Onded_typeChanged();
		...
		[Column(Storage="_ded_id", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		[DataMember(Order=1)]
		public int ded_id
		{
			get
    ...
    partial void Onboo_flagChanged();
		...
		[Column(Storage="_fac_id", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		[DataMember(Order=1)]
		public int fac_id
		{
			get
    ...
    partial void Onfty_changetimeChanged();
		...
		[Column(Storage="_fty_id", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		[DataMember(Order=1)]
		public int fty_id
		{
			get
		...
		public EntitySet<factor> factor
		{
			...
			{
				if ((this.serializing 
							&& (this._factor.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
				return this._factor;
	...
	public partial class person : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _per_sno;
		
		private string _per_name;
		
		private System.Nullable<char> _per_sex;
		
		private string _per_department;
		
		private System.Nullable<System.DateTime> _per_jiontime;
    ...
    partial void Onper_idChanging(int value);
    partial void Onper_idChanged();
    partial void Onper_snoChanging(string value);
    partial void Onper_snoChanged();
    partial void Onper_nameChanging(string value);
    partial void Onper_nameChanged();
    partial void Onper_sexChanging(System.Nullable<char> value);
    partial void Onper_sexChanged();
    partial void Onper_departmentChanging(string value);
    partial void Onper_departmentChanged();
    partial void Onper_jiontimeChanging(System.Nullable<System.DateTime> value);
    partial void Onper_jiontimeChanged();
    #endregion
		...
		[Column(Storage="_per_id", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		[DataMember(Order=1)]
		public int per_id
		{
			get
		...
		[Column(Storage="_per_sno", DbType="NVarChar(20)")]
		[DataMember(Order=2)]
		public string per_sno
		{
			get
			{
				return this._per_sno;
			}
			set
			{
				if ((this._per_sno != value))
				{
					this.Onper_snoChanging(value);
					this.SendPropertyChanging();
					this._per_sno = value;
					this.SendPropertyChanged("per_sno");
					this.Onper_snoChanged();
				}
			}
		}
		
		[Column(Storage="_per_name", DbType="NVarChar(20)")]
		[DataMember(Order=3)]
		...
		[Column(Storage="_per_sex", DbType="NVarChar(1)")]
		[DataMember(Order=4)]
		public System.Nullable<char> per_sex
		{
			get
			{
				return this._per_sex;
			}
			set
			{
				if ((this._per_sex != value))
				{
					this.Onper_sexChanging(value);
					this.SendPropertyChanging();
					this._per_sex = value;
					this.SendPropertyChanged("per_sex");
					this.Onper_sexChanged();
				}
			}
		}
		
		[Column(Storage="_per_department", DbType="NVarChar(20)")]
		[DataMember(Order=5)]
		public string per_department
		{
			get
			{
				return this._per_department;
			}
			set
			{
				if ((this._per_department != value))
				{
					this.Onper_departmentChanging(value);
					this.SendPropertyChanging();
					this._per_department = value;
					this.SendPropertyChanged("per_department");
					this.Onper_departmentChanged();
				}
			}
		}
		
		[Column(Storage="_per_jiontime", DbType="DateTime")]
		[DataMember(Order=6)]
		public System.Nullable<System.DateTime> per_jiontime
		{
			get
			{
				return this._per_jiontime;
			}
			set
			{
				if ((this._per_jiontime != value))
				{
					this.Onper_jiontimeChanging(value);
					this.SendPropertyChanging();
					this._per_jiontime = value;
					this.SendPropertyChanged("per_jiontime");
					this.Onper_jiontimeChanged();
				}
			}
		}
		
		[Association(Name="person_remresult", Storage="_remresult", OtherKey="per_id")]
		[DataMember(Order=7, EmitDefaultValue=false)]
		public EntitySet<remresult> remresult
		{
			...
			{
				if ((this.serializing 
							&& (this._remresult.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
    ...
    partial void Onfac_valueChanged();
		...
		[Association(Name="person_remresult", Storage="_person", ThisKey="per_id", IsForeignKey=true)]
    ...
    partial void Onsal_granttimeChanged();
		...
		[Column(Storage="_sal_id", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		[DataMember(Order=1)]
		public int sal_id
		{
			get
		...
		public EntitySet<sresult> sresult
		{
			...
			{
				if ((this.serializing 
							&& (this._sresult.HasLoadedOrAssignedValues == false)))
				{
					return null;
				}
		...
		internal EntitySet<remresult> remresult
		{
			get
			{
				return this._remresult;
    ...
    partial void Onsre_iscustomChanged();
		...
		[Column(Storage="_sre_id", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		[DataMember(Order=1)]
		public int sre_id
		{
			get
